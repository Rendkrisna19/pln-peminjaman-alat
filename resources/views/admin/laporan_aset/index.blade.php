...
<div class="w-full space-y-6">
    ...
    <div class="bg-white p-6 rounded-3xl border-2 border-gray-200 shadow-sm flex flex-col lg:flex-row justify-between items-center gap-4">
        ...
        <div class="flex gap-2 w-full lg:w-auto">
            <a target="_blank" href="{{ route('admin.laporan-aset.pdf', request()->query()) }}" class="flex-1 lg:flex-none px-5 py-2.5 bg-red-600 text-white font-bold rounded-xl hover:bg-red-700 transition flex items-center justify-center gap-2 text-sm shadow-md">
                <i class="fa-solid fa-file-pdf"></i> Export PDF
            </a>
            <a href="{{ route('admin.laporan-aset.excel', request()->query()) }}" class="flex-1 lg:flex-none px-5 py-2.5 bg-[#107C41] text-white font-bold rounded-xl hover:bg-[#0e6b38] transition flex items-center justify-center gap-2 text-sm shadow-md">
