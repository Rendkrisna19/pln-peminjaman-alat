...
@section('title', 'Edit Unit Operasional')
...
<div class="w-full md:max-w-3xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Edit Unit: <span class="text-pln-cyan">{{ $unit_lokasi->nama_unit }}</span></h1>
    </div>

    <div class="bg-white rounded-2xl shadow-sm border-2 border-gray-200 p-6 sm:p-8">
        <form action="{{ route('admin.unit-lokasi.update', $unit_lokasi->id) }}" method="POST" class="space-y-6">
            @csrf @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nama_unit" value="{{ old('nama_unit', $unit_lokasi->nama_unit) }}" required 
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="jenis_unit" value="{{ old('jenis_unit', $unit_lokasi->jenis_unit) }}" 
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-3 bg-pln-yellow text-gray-900 font-bold rounded-xl shadow-md hover:bg-[#e5c100] transition border-2 border-[#e5c100] flex items-center gap-2">
                    <i class="fa-solid fa-floppy-disk"></i> Update Data Unit
                </button>
            </div>
        </form>
    </div>
